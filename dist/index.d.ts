...
export { getWindowDimension, DeviceWidthObject, getDeviceTypeInfo, isMobileDevice, isTabletDevice, isLaptopDevice, isBiggerThanLaptop, IDeviceWidthInfo, DeviceWidth, IWindowDimensionMetrics, IDeviceTypeInfo, IdResponsiveRenderOnlyIn, Responsive, IdDeviceType, IdDeviceOrientation, IdDeviceTypeBreakdown, IdDeviceBreakpointsByWidth, IdMobileHeight };
